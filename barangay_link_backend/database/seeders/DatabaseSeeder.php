...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // 3. Seed Residents
        $res1 = Resident::firstOrCreate(['email' => 'maria.santos@example.com'], ['name' => 'Maria Santos', 'phone' => '+63 917 123 4567']);
        $res2 = Resident::firstOrCreate(['email' => 'juan.dc@example.com'], ['name' => 'Juan Dela Cruz', 'phone' => '+63 920 456 7890']);
        $res3 = Resident::firstOrCreate(['email' => 'pedro.p@example.com'], ['name' => 'Pedro Penduko', 'phone' => '+63 908 765 4321']);
        $res4 = Resident::firstOrCreate(['email' => 'sarah.lim@example.com'], ['name' => 'Sarah Lim', 'phone' => '+63 945 999 8888']);
        ...
        // 5. Seed Audit Logs (if not present)
        if (AuditLog::count() === 0) {
            AuditLog::create([
        ...
        // 6. Seed Notifications (if not present)
